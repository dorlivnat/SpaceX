...
def get_scatter(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        y='class',
        color='Booster Version Category',
        title='Coorelation between Payload and Success for site CCAFS LC-40')
        return fig
        ...
        y='class',
        color='Booster Version Category',
        title='Coorelation between Payload and Success for site VAFB SLC-4E')
        return fig
        ...
        y='class',
        color='Booster Version Category',
        title='Coorelation between Payload and Success for site KSC LC-39A')
        return fig
        ...
        y='class',
        color='Booster Version Category',
        title='Coorelation between Payload and Success for site CCAFS SLC-40')
        return fig 
